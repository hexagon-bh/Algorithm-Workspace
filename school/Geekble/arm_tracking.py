...
def calculate_angle(a,b,c):
    ...
    angle=round(angle)
    return angle  
with mp_hands.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.8,max_num_hands=2) as hands, mp_pose.Pose(min_detection_confidence=0.3,min_tracking_confidence=0.3) as pose: 
    while cap.isOpened():
        ret, frame = cap.read()
